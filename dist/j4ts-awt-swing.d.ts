...
declare namespace java.awt.geom {
    ...
    abstract class QuadCurve2D implements java.awt.Shape, java.lang.Cloneable {
         ...
         *
         * @return {java.awt.geom.Point2D} a <code>Point2D</code> that is the start point of this <code>QuadCurve2D</code>.
         * @since 1.2
         */
         ...
         *
         * @return {java.awt.geom.Point2D} a <code>Point2D</code> that is the control point of this <code>Point2D</code>.
         * @since 1.2
         */
         ...
         *
         * @return {java.awt.geom.Point2D} a <code>Point</code> object that is the end point of this <code>Point2D</code>.
         * @since 1.2
         */
...
declare namespace java.awt.geom {
     ...
     * {@link *} interface to return the geometry of their boundary by allowing a
     * caller to retrieve the path of that boundary a segment at a time. This interface allows these
     * objects to retrieve the path of their boundary a segment at a time by using 1st through 3rd order
     ...
     * java.awt.BasicStroke} object uses a line "JOIN" decoration to connect the first and
...
declare namespace java.awt.geom {
    ...
    abstract class Line2D implements java.awt.Shape, java.lang.Cloneable {
         ...
         *
         * @return {number} the X coordinate of the start point of this {@code Line2D} object.
         * @since 1.2
         */
        abstract getX1(): number;
        /**
         ...
         *
         * @return {number} the Y coordinate of the start point of this {@code Line2D} object.
         * @since 1.2
         */
        abstract getY1(): number;
        /**
...
declare namespace java.awt.geom {
    ...
    abstract class RectangularShape implements java.awt.Shape, java.lang.Cloneable {
         ...
         * </code> precision.
         *
         * @return {number} the X coordinate of the upper-left corner of the framing rectangle.
         * @since 1.2
         */
        abstract getX(): number;
        /**
         ...
         * </code> precision.
         *
         * @return {number} the Y coordinate of the upper-left corner of the framing rectangle.
         * @since 1.2
         */
        abstract getY(): number;
        /**
        ...
        /**
         * Determines whether the <code>RectangularShape</code> is empty. When the <code>RectangularShape
         * </code> is empty, it encloses no area.
         *
         * @return {boolean} <code>true</code> if the <code>RectangularShape</code> is empty; <code>false</code>
         * otherwise.
         * @since 1.2
         */
...
declare namespace java.awt.geom {
    ...
    abstract class CubicCurve2D implements java.awt.Shape, java.lang.Cloneable {
         ...
         * Returns the start point.
         *
         * @return {java.awt.geom.Point2D} a {@code Point2D} that is the start point of the {@code CubicCurve2D}.
         * @since 1.2
         */
        abstract getP1(): java.awt.geom.Point2D;
        /**
         ...
         *
         * @return {number} the X coordinate of the first control point of the {@code CubicCurve2D}.
         * @since 1.2
         */
         ...
         *
         * @return {number} the Y coordinate of the first control point of the {@code CubicCurve2D}.
         * @since 1.2
         */
         ...
         *
         * @return {java.awt.geom.Point2D} a {@code Point2D} that is the first control point of the {@code CubicCurve2D}.
         * @since 1.2
         */
         ...
         *
         * @return {number} the X coordinate of the second control point of the {@code CubicCurve2D}.
         * @since 1.2
         */
         ...
         *
         * @return {number} the Y coordinate of the second control point of the {@code CubicCurve2D}.
         * @since 1.2
         */
         ...
         *
         * @return {java.awt.geom.Point2D} a {@code Point2D} that is the second control point of the {@code CubicCurve2D}.
         * @since 1.2
         */
         ...
         * Returns the end point.
         *
         * @return {java.awt.geom.Point2D} a {@code Point2D} that is the end point of the {@code CubicCurve2D}.
         * @since 1.2
         */
        abstract getP2(): java.awt.geom.Point2D;
...
declare namespace java.awt.event {
     ...
     * the abstract <code>ContainerAdapter</code> class (overriding only the methods of interest). The
     * listener object created from that class is then registered with a component using the component's
     * <code>addContainerListener</code> method. When the container's contents change because a
     ...
     *
     * <p>Container events are provided for notification purposes ONLY; The AWT will automatically
     * handle add and remove operations internally so the program works properly regardless of whether
     * the program registers a {@code ContainerListener} or not.
     *
...
declare namespace java.awt.event {
     ...
     * or extends the abstract <code>KeyAdapter</code> class (overriding only the methods of interest).
     *
     * <p>The listener object created from that class is then registered with a component using the
     * component's <code>addKeyListener</code> method. A keyboard event is generated when a key is
     * pressed, released, or typed. The relevant method in the listener object is then invoked, and the
...
declare namespace java.awt.event {
     ...
     * mouse events, use the <code>MouseListener</code>. For mouse movement and drags, use the <code>
     * MouseMotionListener</code>.)
     *
     * <p>The class that is interested in processing a mouse wheel event implements this interface (and
     * all the methods it contains).
     *
     * <p>The listener object created from that class is then registered with a component using the
     * component's <code>addMouseWheelListener</code> method. A mouse wheel event is generated when the
     * mouse wheel is rotated. When a mouse wheel event occurs, that object's <code>mouseWheelMoved
     * </code> method is invoked.
     *
     * <p>For information on how mouse wheel events are dispatched, see the class description for {@link
     * MouseWheelEvent}.
     *
...
declare namespace java.awt.event {
     ...
     * MouseMotionListener</code>.)
     *
     * <p>The class that is interested in processing a mouse event either implements this interface (and
     * all the methods it contains) or extends the abstract <code>MouseAdapter</code> class (overriding
     * only the methods of interest).
     *
     * <p>The listener object created from that class is then registered with a component using the
     * component's <code>addMouseListener</code> method. A mouse event is generated when the mouse is
...
declare namespace java.awt.event {
     ...
     * the abstract <code>ComponentAdapter</code> class (overriding only the methods of interest). The
     * listener object created from that class is then registered with a component using the component's
     * <code>addComponentListener</code> method. When the component's size, location, or visibility
     * changes, the relevant method in the listener object is invoked, and the <code>ComponentEvent
     * </code> is passed to it.
     *
     * <p>Component events are provided for notification purposes ONLY; The AWT will automatically
...
declare namespace java.awt.event {
     ...
     * a component using the component's <code>addItemListener</code> method. When an item-selection
     * event occurs, the listener object's <code>itemStateChanged</code> method is invoked.
     *
     * @author Amy Fowler
...
declare namespace java.awt.event {
     ...
     * abstract <code>WindowAdapter</code> class (overriding only the methods of interest). The listener
     * object created from that class is then registered with a Window using the window's <code>
     * addWindowListener</code> method. When the window's status changes by virtue of being opened,
...
declare namespace java.awt.event {
     ...
     * mouse events, use the <code>MouseListener</code>.)
     *
     * <p>The class that is interested in processing a mouse motion event either implements this
     * interface (and all the methods it contains) or extends the abstract <code>MouseMotionAdapter
     * </code> class (overriding only the methods of interest).
     *
     * <p>The listener object created from that class is then registered with a component using the
     * component's <code>addMouseMotionListener</code> method. A mouse motion event is generated when
     * the mouse is moved or dragged. (Many such events will be generated). When a mouse motion event
     * occurs, the relevant method in the listener object is invoked, and the <code>MouseEvent</code> is
     * passed to it.
     *
     * @author Amy Fowler
    ...
    interface MouseMotionListener extends java.util.EventListener {
         ...
         * </code> events will continue to be delivered to the component where the drag originated until
         * the mouse button is released (regardless of whether the mouse position is within the bounds of
         * the component).
         *
         * <p>Due to platform-dependent Drag&amp;Drop implementations, <code>MOUSE_DRAGGED</code> events
...
declare namespace java.awt.event {
     ...
     *
     * <p>The class that is interested in processing a window state event either implements this
     * interface (and all the methods it contains) or extends the abstract <code>WindowAdapter</code>
     * class (overriding only the methods of interest).
     *
     * <p>The listener object created from that class is then registered with a window using the <code>
     * Window</code>'s <code>addWindowStateListener</code> method. When the window's state changes by
     * virtue of being iconified, maximized etc., the <code>windowStateChanged</code> method in the
     * listener object is invoked, and the <code>WindowEvent</code> is passed to it.
     *
...
declare namespace java.awt.event {
     ...
     * contains) or extends the abstract <code>FocusAdapter</code> class (overriding only the methods of
     * interest). The listener object created from that class is then registered with a component using
     * the component's <code>addFocusListener</code> method. When the component gains or loses the
     * keyboard focus, the relevant method in the listener object is invoked, and the <code>FocusEvent
     * </code> is passed to it.
     *
     * @see FocusAdapter
     * @see FocusEvent
...
declare namespace java.awt.event {
    /**
     * The listener interface for receiving <code>WindowEvents</code>, including <code>
     * WINDOW_GAINED_FOCUS</code> and <code>WINDOW_LOST_FOCUS</code> events. The class that is
     * interested in processing a <code>WindowEvent</code> either implements this interface (and all the
     * methods it contains) or extends the abstract <code>WindowAdapter</code> class (overriding only
     * the methods of interest). The listener object created from that class is then registered with a
     * <code>Window</code> using the <code>Window</code>'s <code>addWindowFocusListener</code> method.
     * When the <code>Window</code>'s status changes by virtue of it being opened, closed, activated,
     * deactivated, iconified, or deiconified, or by focus being transfered into or out of the <code>
     * Window</code>, the relevant method in the listener object is invoked, and the <code>WindowEvent
     * </code> is passed to it.
     *
     * @author David Mendenhall
     * @see WindowAdapter
...
declare namespace java.awt.event {
     ...
     *
     * <p>The class that is interested in processing a text event implements this interface. The object
     * created with that class is then registered with a component using the component's <code>
     * addTextListener</code> method. When the component's text changes, the listener object's <code>
     * textValueChanged</code> method is invoked.
     *
     * @author Georges Saab
     * @see TextEvent
     * @since 1.1
...
declare namespace java.awt {
    ...
    class Color implements java.awt.Paint, java.io.Serializable {
        ...
        value: number;
        /**
         * The color value in the default sRGB <code>ColorSpace</code> as <code>float</code> components
         * (no alpha). If <code>null</code> after object construction, this must be an sRGB color
         * constructed with 8-bit precision, so compute from the <code>int</code> color value.
         *
         * @serial
...
declare namespace java.awt {
    /**
     * The <code>Shape</code> interface provides definitions for objects that represent some form of
     * geometric shape. The <code>Shape</code> is described by a {@link PathIterator} object, which can
     * express the outline of the <code>Shape</code> as well as a rule for determining how the outline
     * divides the 2D plane into interior and exterior points. Each <code>Shape</code> object provides
     * callbacks to get the bounding box of the geometry, determine whether points or rectangles lie
     * partly or entirely within the interior of the <code>Shape</code>, and retrieve a <code>
     * PathIterator</code> object that describes the trajectory path of the <code>Shape</code> outline.
     *
     * <p><a name="def_insideness"><b>Definition of insideness:</b></a> A point is considered to lie
     * inside a <code>Shape</code> if and only if:
     *
     * <ul>
     * <li>it lies completely inside the<code>Shape</code> boundary <i>or</i>
     * <li>it lies exactly on the <code>Shape</code> boundary <i>and</i> the space immediately
     * adjacent to the point in the increasing <code>X</code> direction is entirely inside the
     * boundary <i>or</i>
     * <li>it lies exactly on a horizontal boundary segment <b>and</b> the space immediately adjacent
     * to the point in the increasing <code>Y</code> direction is inside the boundary.
     * </ul>
     *
     * <p>The <code>contains</code> and <code>intersects</code> methods consider the interior of a
     * <code>Shape</code> to be the area it encloses as if it were filled. This means that these methods
     * consider unclosed shapes to be implicitly closed for the purpose of determining if a shape
     * contains or intersects a rectangle or if a shape contains a point.
     *
    ...
    interface Shape {
         ...
         *
         * <p>Note that the <a href="{@docRoot}/java/awt/Shape.html#def_insideness">definition of
         * insideness</a> can lead to situations where points on the defining outline of the {@code shape}
         * may not be considered contained in the returned {@code bounds} object, but only in cases where
         * those points are also not considered contained in the original {@code shape}.
         *
         * <p>If a {@code point} is inside the {@code shape} according to the {@link #contains(double x,
         * double y) contains(point)} method, then it must be inside the returned {@code Rectangle} bounds
         * object according to the {@link #contains(double x, double y) contains(point)} method of the
         * {@code bounds}. Specifically:
         *
         * <p>{@code shape.contains(x,y)} requires {@code bounds.contains(x,y)}
         *
         * <p>If a {@code point} is not inside the {@code shape}, then it might still be contained in the
         * {@code bounds} object:
         *
         * <p>{@code bounds.contains(x,y)} does not imply {@code shape.contains(x,y)}
         *
         * @return {java.awt.Rectangle} an integer <code>Rectangle</code> that completely encloses the <code>Shape</code>.
         * @see #getBounds2D
         * @since 1.2
         */
        getBounds(): java.awt.Rectangle;
         ...
         * those points are also not considered contained in the original {@code shape}.
         *
         * <p>If a {@code point} is inside the {@code shape} according to the {@link #contains(Point2D p)
         * contains(point)} method, then it must be inside the returned {@code Rectangle2D} bounds object
         * according to the {@link #contains(Point2D p) contains(point)} method of the {@code bounds}.
         * Specifically:
         *
         ...
         *
         * @return {java.awt.geom.Rectangle2D} an instance of <code>Rectangle2D</code> that is a high-precision bounding box of the
         * <code>Shape</code>.
         * @see #getBounds
         * @since 1.2
         */
         ...
         * rectangular area does not intersect the {@code Shape}. The {@link java.awt.geom.Area}
         ...
         * @param {number} w the width of the specified rectangular area
         * @param {number} h the height of the specified rectangular area
         * @return {boolean} <code>true</code> if the interior of the <code>Shape</code> and the interior of the
         ...
         * </code> for the entire rectangular area to be considered contained within the <code>Shape
         * </code>.
         *
         * <p>The {@code Shape.contains()} method allows a {@code Shape} implementation to conservatively
         ...
         * </ul>
         *
         * This means that for some {@code Shapes} this method might return {@code false} even though the
         * {@code Shape} contains the rectangular area. The {@link java.awt.geom.Area} class performs
         * more accurate geometric computations than most {@code Shape} objects and therefore can be used
         ...
         * @param {number} w the width of the specified rectangular area
         * @param {number} h the height of the specified rectangular area
         * @return {boolean} <code>true</code> if the interior of the <code>Shape</code> entirely contains the
...
declare namespace java.awt {
     ...
     * object.
     *
     * <p>This interface extends the LayoutManager interface to deal with layouts explicitly in terms of
     * constraint objects that specify how and where components should be added to the layout.
     *
     * <p>This minimal extension to LayoutManager is intended for tool providers who wish to the
     * creation of constraint-based layouts. It does not yet provide full, general support for custom
...
declare namespace java.beans {
    abstract class ChangeListenerMap<L extends java.util.EventListener> {
        ...
        /**
         * Extracts a real listener from the proxy listener. It is necessary because default proxy class
         * is not serializable.
         *
...
declare namespace sun.awt.geom {
    interface PathConsumer2D {
        ...
        closePath(): any;
        /**
         * Called after the last segment of the last subpath when the iteration of the path segments is
         * completely done. This method serves to trigger the end of path processing in the consumer that
         * would normally be triggered when a {@link *} returns
         * {@code true} from its {@code done} method.
         */
        pathDone(): any;
        /**
         * If a given PathConsumer performs all or most of its work natively then it can return a
         * (non-zero) pointer to a native function vector that defines C functions for all of the above
         * methods. The specific pointer it returns is a pointer to a PathConsumerVec structure as defined
         * in the include file src/share/native/sun/java2d/pipe/PathConsumer2D.h
         *
...
declare namespace javax.swing {
    /**
     * This interface defines the methods components like JList use to get the value of each cell in a
     * list and the length of the list. Logically the model is a vector, indices vary from 0 to
     * ListDataModel.getSize() - 1. Any change to the contents or length of the data model must be
     * reported to all of the ListDataListeners.
     *
...
declare namespace javax.swing.event {
    ...
    interface PopupMenuListener extends java.util.EventListener {
        ...
        /**
         * This method is called before the popup menu becomes invisible Note that a JPopupMenu can become
         * invisible any time
         * @param {javax.swing.event.PopupMenuEvent} e
         */
...
declare namespace javax.swing {
    ...
    interface MutableComboBoxModel<E> extends javax.swing.ComboBoxModel<E> {
        /**
         * Adds an item at the end of the model. The implementation of this method should notify all
         * registered <code>ListDataListener</code>s that the item has been added.
         *
         * @param {*} item the item to be added
         */
        addElement(item: E): any;
        /**
         * Removes an item from the model. The implementation of this method should should notify all
         * registered <code>ListDataListener</code>s that the item has been removed.
         *
         * @param {*} obj the <code>Object</code> to be removed
         */
        removeElement(obj: any): any;
        /**
         * Adds an item at a specific index. The implementation of this method should notify all
         * registered <code>ListDataListener</code>s that the item has been added.
         *
         * @param {*} item the item to be added
        ...
        /**
         * Removes an item at a specific index. The implementation of this method should notify all
         * registered <code>ListDataListener</code>s that the item has been removed.
         *
...
declare namespace javax.swing {
    /**
     * Any component that can be placed into a menu should implement this interface. This interface is
     * used by <code>MenuSelectionManager</code> to handle selection and navigation in menu hierarchies.
     *
     * @author Arnaud Weber
     * @class
     */
    interface MenuElement {
        ...
        /**
         * Call by the <code>MenuSelectionManager</code> when the <code>MenuElement</code> is added or
        ...
        /**
         * This method should return the java.awt.Component used to paint the receiving element. The
         * returned component will be used to convert events and detect if an event is inside a
...
declare namespace javax.swing.text {
    /**
     * Represents a location within a document. It is intended to abstract away implementation details
     * of the document and enable specification of positions within the document that are capable of
     * tracking of change as the document is edited.
     *
     * <p>A {@code Position} object points at a location between two characters. As the surrounding
     * content is altered, the {@code Position} object adjusts its offset automatically to reflect the
     * changes. If content is inserted or removed before the {@code Position} object's location, then
     * the {@code Position} increments or decrements its offset, respectively, so as to point to the
     * same location. If a portion of the document is removed that contains a {@code Position}'s offset,
     * then the {@code Position}'s offset becomes that of the beginning of the removed region. For
     * example, if a {@code Position} has an offset of 5 and the region 2-10 is removed, then the {@code
     * Position}'s offset becomes 2.
     *
     * <p>{@code Position} with an offset of 0 is a special case. It never changes its offset while
     * document content is altered.
     *
...
declare namespace javax.swing {
    /**
     * This interface represents the current state of the selection for any of the components that
     * display a list of values with stable indices. The selection is modeled as a set of intervals,
     * each interval represents a contiguous range of selected list elements. The methods for modifying
     * the set of selected intervals all take a pair of indices, index0 and index1, that represent a
    ...
    interface ListSelectionModel {
         ...
         * addSelectionInterval() or removeSelectionInterval(). The most recent index0 is considered the
         * "anchor" and the most recent index1 is considered the "lead". Some interfaces display these
         * indices specially, e.g. Windows95 displays the lead index with a dotted yellow outline.
         *
         * @see #getLeadSelectionIndex
         * @see #setSelectionInterval
        ...
        /**
         * Return the second index argument from the most recent call to setSelectionInterval(),
        ...
        /**
         * Change the selection to the empty set. If this represents a change to the current selection
         * then notify each ListSelectionListener.
         *
         * @see #addListSelectionListener
         */
        clearSelection(): any;
        ...
        isSelectionEmpty(): boolean;
        /**
         * Insert length indices beginning before/after index. This is typically called to sync the
         * selection model with a corresponding change in the data model.
         * @param {number} index
         * @param {number} length
         * @param {boolean} before
        ...
        /**
         * Sets the {@code valueIsAdjusting} property, which indicates whether or not upcoming selection
         * changes should be considered part of a single change. The value of this property is used to
         * initialize the {@code valueIsAdjusting} property of the {@code ListSelectionEvent}s that are
         * generated.
         *
         * <p>For example, if the selection is being updated in response to a user drag, this property can
         * be set to {@code true} when the drag is initiated and set to {@code false} when the drag is
         * finished. During the drag, listeners receive events with a {@code valueIsAdjusting} property
         * set to {@code true}. At the end of the drag, when the change is finalized, listeners receive an
         * event with the value set to {@code false}. Listeners can use this pattern if they wish to
         * update only when a change has been finalized.
         *
         * <p>Setting this property to {@code true} begins a series of changes that is to be considered
         * part of a single change. When the property is changed back to {@code false}, an event is sent
         * out characterizing the entire selection change (if there was one), with the event's {@code
         * valueIsAdjusting} property set to {@code false}.
         *
         ...
         * immediately adjacent to or overlaps the existing selection, and can therefore be used to
         * grow it.
...
declare namespace javax.swing {
    /**
     * A data model for a combo box. This interface extends <code>ListDataModel</code> and adds the
     * concept of a <i>selected item</i>. The selected item is generally the item which is visible in
     * the combo box display area.
     *
     * <p>The selected item may not necessarily be managed by the underlying <code>ListModel</code>.
     * This disjoint behavior allows for the temporary storage and retrieval of a selected item in the
     * model.
     *
     * @param <E> the type of the elements of this model
     * @author Arnaud Weber
...
declare namespace javax.swing {
    /**
     * Defines the data model used by components like <code>Slider</code>s and <code>ProgressBar</code>
     * s. Defines four interrelated integer properties: minimum, maximum, extent and value. These four
     ...
     * </pre>
     *
     * The outer range is <code>minimum,maximum</code> and the inner range is <code>value,value+extent
     * </code>. The inner range must lie within the outer one, i.e. <code>value</code> must be less than
     * or equal to <code>maximum</code> and <code>value+extent</code> must greater than or equal to
     * <code>minimum</code>, and <code>maximum</code> must be greater than or equal to <code>minimum
     * </code>. There are a few features of this model that one might find a little surprising. These
     * quirks exist for the convenience of the Swing BoundedRangeModel clients, such as <code>Slider
     * </code> and <code>ScrollBar</code>.
     *
     * <ul>
     * <li>The minimum and maximum set methods "correct" the other three properties to accommodate
     * their new value argument. For example setting the model's minimum may change its maximum,
     ...
     * by the other three properties. For example if <code>value == maximum</code>, <code>
     ...
     * ChangeEvents are used to notify clients of changes rather than PropertyChangeEvents. This
     * was done to keep the overhead of monitoring a BoundedRangeModel low. Changes are often
     * reported at MouseDragged rates.
     * </ul>
     *
     * <p>For an example of specifying custom bounded range models used by sliders, see <a
    ...
    interface BoundedRangeModel {
        ...
        getMinimum(): number;
        /**
         * Sets the model's minimum to <I>newMinimum</I>. The other three properties may be changed as
         * well, to ensure that:
         *
         * <pre>
         * minimum &lt;= value &lt;= value+extent &lt;= maximum
        ...
        getMaximum(): number;
        /**
         * Sets the model's maximum to <I>newMaximum</I>. The other three properties may be changed as
         * well, to ensure that
         *
         * <pre>
         * minimum &lt;= value &lt;= value+extent &lt;= maximum
        ...
        /**
         * Returns the model's current value. Note that the upper limit on the model's value is <code>
         * maximum - extent</code> and the lower limit is <code>minimum</code>.
         *
        ...
        getValue(): number;
        /**
         * Sets the model's current value to <code>newValue</code> if <code>newValue</code> satisfies the
         ...
         * </pre>
         *
         * Otherwise, if <code>newValue</code> is less than <code>minimum</code> it's set to <code>minimum
         * </code>, if its greater than <code>maximum</code> then it's set to <code>maximum</code>, and if
         * it's greater than <code>value+extent</code> then it's set to <code>value+extent</code>.
         *
        ...
        getExtent(): number;
        /**
         * Sets the model's extent. The <I>newExtent</I> is forced to be greater than or equal to zero and
         * less than or equal to maximum - value.
         *
         * <p>When a BoundedRange model is used with a scrollbar the extent defines the length of the
         * scrollbar knob (aka the "thumb" or "elevator"). The extent usually represents how much of the
         * object being scrolled is visible. When used with a slider, the extent determines how much the
         * value can "jump", for example when the user presses PgUp or PgDn.
         *
         * <p>Notifies any listeners if the model changes.
         *
        ...
        /**
         * This method sets all of the model's data with a single method call. The method results in a
         * single change event being generated. This is convenient when you need to adjust all the model
         * data simultaneously and do not want individual change events to occur.
         *
         ...
         * @param {boolean} adjusting a boolean, true if a series of changes are in progress
         * @see #setValue
         * @see #setExtent
         * @see #setMinimum
         * @see #setMaximum
...
declare namespace javax.swing {
     ...
     * JWindow, JApplet, JInternalFrame. The methods in this interface are just <i>covers</i> for the
     * JRootPane properties, e.g. <code>getContentPane()</code> is generally implemented like this:
     *
     * <pre>
     ...
     * </pre>
     *
     * This interface serves as a <i>marker</i> for Swing GUI builders that need to treat components
     * like JFrame, that contain a single JRootPane, specially. For example in a GUI builder, dropping a
     * component on a RootPaneContainer would be interpreted as <code>frame.getContentPane().add(child)
     * </code>.
     *
     * <p>As a convenience, the standard classes that implement this interface (such as {@code JFrame},
     * {@code JDialog}, {@code JWindow}, {@code JApplet}, and {@code JInternalFrame}) have their {@code
     * add}, {@code remove}, and {@code setLayout} methods overridden, so that they delegate calls to
     * the corresponding methods of the {@code ContentPane}. For example, you can add a child component
     * to a frame as follows:
     *
     * <pre>
     * frame.add(child);
     * </pre>
     ...
     * </pre>
     *
     * <p>The behavior of the <code>add</code> and <code>setLayout</code> methods for <code>JFrame
     * </code>, <code>JDialog</code>, <code>JWindow</code>, <code>JApplet</code> and <code>
     * JInternalFrame</code> is controlled by the <code>rootPaneCheckingEnabled</code> property. If this
     * property is true (the default), then calls to these methods are forwarded to the <code>
     * contentPane</code>; if false, these methods operate directly on the <code>RootPaneContainer
     * </code>. This property is only intended for subclasses, and is therefore protected.
     *
     * @see JRootPane
     * @see JFrame
     * @see JDialog
    ...
    interface RootPaneContainer {
        /**
         * Return this component's single JRootPane child. A conventional implementation of this interface
         * will have all of the other methods indirect through this one. The rootPane has two children:
         * the glassPane and the layeredPane.
         *
        ...
        /**
         * The "contentPane" is the primary container for application specific components. Applications
         * should add children to the contentPane, set its layout manager, and so on.
         *
         * <p>The contentPane may not be null.
         *
         * <p>Generally implemented with <code>getRootPane().setContentPane(contentPane);</code>
         *
         * @exception java.awt.IllegalComponentStateException (a runtime exception) if the content pane
         * parameter is null
         * @param {java.awt.Container} contentPane the Container to use for the contents of this JRootPane
...
declare namespace javax.swing.undo {
    ...
    class AbstractUndoableEdit implements javax.swing.undo.UndoableEdit, java.io.Serializable {
        ...
        hasBeenDone: boolean;
        /**
         * True if this edit has not received <code>die</code>; defaults to <code>true</code>.
         */
        alive: boolean;
        constructor();
        /**
...
declare namespace javax.swing.undo {
    /**
     * An <code>UndoableEdit</code> represents an edit. The edit may be undone, or if already undone the
     * edit may be redone.
     *
     * <p><code>UndoableEdit</code> is designed to be used with the <code>UndoManager</code>. As <code>
     * UndoableEdit</code>s are generated by an <code>UndoableEditListener</code> they are typically
     * added to the <code>UndoManager</code>. When an <code>UndoableEdit</code> is added to an <code>
     * UndoManager</code> the following occurs (assuming <code>end</code> has not been called on the
     * <code>UndoManager</code>):
     *
     * <ol>
     * <li>If the <code>UndoManager</code> contains edits it will call <code>addEdit</code> on the
     * current edit passing in the new edit as the argument. If <code>addEdit</code> returns true
     * the new edit is assumed to have been incorporated into the current edit and the new edit
     * will not be added to the list of current edits. Edits can use <code>addEdit</code> as a way
     * for smaller edits to be incorporated into a larger edit and treated as a single edit.
     * <li>If <code>addEdit</code> returns false <code>replaceEdit</code> is called on the new edit
     * with the current edit passed in as the argument. This is the inverse of <code>addEdit
     * </code> &#151; if the new edit returns true from <code>replaceEdit</code>, the new edit
     * replaces the current edit.
     * </ol>
     *
     * The <code>UndoManager</code> makes use of <code>isSignificant</code> to determine how many edits
     * should be undone or redone. The <code>UndoManager</code> will undo or redo all insignificant
     * edits (<code>isSignificant</code> returns false) between the current edit and the last or next
     * significant edit. <code>addEdit</code> and <code>replaceEdit</code> can be used to treat multiple
     * edits as a single edit, returning false from <code>isSignificant</code> allows for treating can
     * be used to have many smaller edits undone or redone at once. Similar functionality can also be
     * done using the <code>addEdit</code> method.
     *
     * @author Ray Ryan
     * @class
     */
    interface UndoableEdit {
        ...
        canRedo(): boolean;
        /**
         * Informs the edit that it should no longer be used. Once an <code>UndoableEdit</code> has been
         * marked as dead it can no longer be undone or redone.
         *
         * <p>This is a useful hook for cleaning up state no longer needed once undoing or redoing is
         * impossible--for example, deleting file resources used by objects that can no longer be
         * undeleted. <code>UndoManager</code> calls this before it dequeues edits.
         *
         * <p>Note that this is a one-way operation. There is no "un-die" method.
         *
         * @see CompoundEdit#die
         */
        die(): any;
        /**
         * Adds an <code>UndoableEdit</code> to this <code>UndoableEdit</code>. This method can be used to
         * coalesce smaller edits into a larger compound edit. For example, text editors typically allow
         * undo operations to apply to words or sentences. The text editor may choose to generate edits on
         * each key event, but allow those edits to be coalesced into a more user-friendly unit, such as a
         * word. In this case, the <code>UndoableEdit</code> would override <code>addEdit</code> to return
         * true when the edits may be coalesced.
         *
         * <p>A return value of true indicates <code>anEdit</code> was incorporated into this edit. A
         * return value of false indicates <code>anEdit</code> may not be incorporated into this edit.
         *
         * <p>Typically the receiver is already in the queue of a <code>UndoManager</code> (or other
         * <code>UndoableEditListener</code>), and is being given a chance to incorporate <code>anEdit
         * </code> rather than letting it be added to the queue in turn.
         *
         * <p>If true is returned, from now on <code>anEdit</code> must return false from <code>canUndo
         * </code> and <code>canRedo</code>, and must throw the appropriate exception on <code>undo</code>
         * or <code>redo</code>.
         *
         * @param {*} anEdit the edit to be added
         * @return {boolean} true if <code>anEdit</code> may be incorporated into this edit
         */
        addEdit(anEdit: UndoableEdit): boolean;
        /**
         * Returns true if this <code>UndoableEdit</code> should replace <code>anEdit</code>. This method
         * is used by <code>CompoundEdit</code> and the <code>UndoManager</code>; it is called if <code>
         * anEdit</code> could not be added to the current edit (<code>addEdit</code> returns false).
         *
         * <p>This method provides a way for an edit to replace an existing edit.
         *
         * <p>This message is the opposite of addEdit--anEdit has typically already been queued in an
         * <code>UndoManager</code> (or other UndoableEditListener), and the receiver is being given a
         * chance to take its place.
         *
         * <p>If true is returned, from now on anEdit must return false from canUndo() and canRedo(), and
         * must throw the appropriate exception on undo() or redo().
         *
        ...
        /**
         * Returns true if this edit is considered significant. A significant edit is typically an edit
         * that should be presented to the user, perhaps on a menu item or tooltip. The <code>UndoManager
         * </code> will undo, or redo, all insignificant edits to the next significant edit.
         *
         * @return {boolean} true if this edit is significant
         */
        isSignificant(): boolean;
        /**
         * Returns a localized, human-readable description of this edit, suitable for use in a change log,
         * for example.
         *
        ...
        getPresentationName(): string;
        /**
         * Returns a localized, human-readable description of the undoable form of this edit, suitable for
         * use as an Undo menu item, for example. This is typically derived from <code>getPresentationName
         * </code>.
         *
        ...
        getUndoPresentationName(): string;
        /**
         * Returns a localized, human-readable description of the redoable form of this edit, suitable for
         * use as a Redo menu item, for example. This is typically derived from <code>getPresentationName
         * </code>.
         *
...
declare namespace javax.swing.undo {
    /**
     * StateEditable defines the interface for objects that can have their state undone/redone by a
     * StateEdit.
     *
     * @see StateEdit
     * @class
...
declare namespace java.awt.geom {
    ...
    abstract class Path2D implements java.awt.Shape, java.lang.Cloneable {
         ...
         *
         * @param {java.awt.geom.AffineTransform} at the {@code AffineTransform} used to transform the area
         * @since 1.6
         */
...
declare namespace java.awt.geom {
    ...
    abstract class RoundRectangle2D extends java.awt.geom.RectangularShape {
         ...
         *
         * @return {number} the width of the arc that rounds off the corners of this <code>RoundRectangle2D</code>.
         * @since 1.2
         */
         ...
         *
         * @return {number} the height of the arc that rounds off the corners of this <code>RoundRectangle2D</code>
         * .
         * @since 1.2
         */
...
declare namespace java.awt.geom {
    ...
    abstract class Rectangle2D extends java.awt.geom.RectangularShape {
        ...
        contains(x?: any, y?: any, w?: any, h?: any): boolean;
        /**
         * Returns a new <code>Rectangle2D</code> object representing the intersection of this <code>
         * Rectangle2D</code> with the specified <code>Rectangle2D</code>.
         *
         * @param {java.awt.geom.Rectangle2D} r the <code>Rectangle2D</code> to be intersected with this <code>Rectangle2D</code>
         * @return {java.awt.geom.Rectangle2D} the largest <code>Rectangle2D</code> contained in both the specified <code>Rectangle2D
         * </code> and in this <code>Rectangle2D</code>.
         * @since 1.2
         */
        ...
        /**
         * Returns a new <code>Rectangle2D</code> object representing the union of this <code>Rectangle2D
         * </code> with the specified <code>Rectangle2D</code> .
         *
         * @param {java.awt.geom.Rectangle2D} r the <code>Rectangle2D</code> to be combined with this <code>Rectangle2D</code>
         * @return {java.awt.geom.Rectangle2D} the smallest <code>Rectangle2D</code> containing both the specified <code>Rectangle2D
         * </code> and this <code>Rectangle2D</code>.
         * @since 1.2
         */
...
declare namespace java.awt.geom {
    ...
    abstract class Arc2D extends java.awt.geom.RectangularShape {
         ...
         *
         * @return {number} A double value that represents the starting angle of the arc in degrees.
         * @see #setAngleStart
         * @since 1.2
         */
         ...
         *
         * @return {number} A double value that represents the angular extent of the arc in degrees.
         * @see #setAngleExtent
         * @since 1.2
         */
        ...
        getBounds2D(): java.awt.geom.Rectangle2D;
        /**
         * Constructs a <code>Rectangle2D</code> of the appropriate precision to hold the parameters
         ...
         * @param {number} w The width of the framing rectangle.
         * @param {number} h The height of the framing rectangle.
         * @return {java.awt.geom.Rectangle2D} a <code>Rectangle2D</code> that is the framing rectangle of this arc.
         * @since 1.2
         */
...
declare namespace java.awt.event {
    ...
    class AdjustmentEvent extends java.awt.AWTEvent {
        ...
        /**
         * <code>value</code> will contain the new value of the adjustable object. This value will always
         * be in a range associated adjustable object.
         *
         * @serial
         * @see #getValue
         */
        value: number;
        /**
         * The <code>adjustmentType</code> describes how the adjustable object value has changed. This
         * value can be increased/decreased by a block or unit amount where the block is associated with
         * page increments/decrements, and a unit is associated with line increments/decrements.
         *
         * @serial
         * @see #getAdjustmentType
         */
        ...
        /**
         * The <code>isAdjusting</code> is true if the event is one of the series of multiple adjustment
         * events.
         *
         * @since 1.4
         * @serial
...
declare namespace javax.swing.undo {
    ...
    class CompoundEdit extends javax.swing.undo.AbstractUndoableEdit {
        ...
        inProgress: boolean;
        /**
         * The collection of <code>UndoableEdit</code>s undone/redone en masse by this <code>CompoundEdit
         * </code>.
         */
...
declare namespace java.awt.event {
    ...
    class WindowEvent extends java.awt.event.ComponentEvent {
         ...
         * Window, which means that the Window, or one of its subcomponents, will receive keyboard events.
         */
...
declare namespace java.awt {
    class Window extends java.awt.Container {
         ...
         * window that has a security manager installed that denies {@code
         * AWTPermission("showWindowWithoutWarningBanner")}. This message can be displayed anywhere in the
         * window.
         *
         * @serial
...
declare namespace java.awt {
    class Frame extends java.awt.Window {
         ...
         * vertically). It is just a convenience alias for <code>
         * MAXIMIZED_VERT&nbsp;|&nbsp;MAXIMIZED_HORIZ</code>.
         *
        ...
        /**
         * This is the title of the frame. It can be changed at any time. <code>title</code> can be null
         * and if this is the case the <code>title</code> = "".
         *
         * @serial
         * @see #getTitle
         * @see #setTitle(String)
         ...
         * <code>resizable</code> will be true if the frame is resizable, otherwise it will be false.
         *
         * @serial
         * @see #isResizable()
         */
         ...
         * the frame is not displayable. <code>undecorated</code> will be true if the frame is
...
declare namespace javax.swing {
    ...
    class JRootPane extends javax.swing.JComponent {
        ...
        /**
         * The button that gets activated when the pane has the focus and a UI-specific action like
         * pressing the <b>Enter</b> key occurs.
         */
...
declare namespace javax.swing {
    abstract class AbstractButton extends javax.swing.JComponent implements java.awt.ItemSelectable, javax.swing.SwingConstants {
        ...
        /**
         * Only one <code>ChangeEvent</code> is needed per button instance since the event's only state is
         * the source property. The source of events generated is always "this".
         */
        changeEvent: javax.swing.event.ChangeEvent;
...
declare namespace javax.swing {
    ...
    class JApplet extends java.applet.Applet implements javax.swing.RootPaneContainer {
        ...
        /**
         * If true then calls to <code>add</code> and <code>setLayout</code> will be forwarded to the
         * <code>contentPane</code>. This is initially false, but is set to true when the <code>JApplet
         * </code> is constructed.
         *
