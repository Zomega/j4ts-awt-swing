...
/**
 * An abstract implementation of <code>UndoableEdit</code>, implementing simple responses to all
 * boolean methods in that interface.
 *
 * @author Ray Ryan
 */
public class AbstractUndoableEdit implements UndoableEdit, Serializable {
   ...
   * </code>.
   *
   * @return true if this edit is <code>alive</code> and <code>hasBeenDone</code> is <code>true
   *     </code>
   * @see #die
   * @see #undo
   * @see #redo
  ...
  public String toString() {
    return getClass().getName() + " hasBeenDone: " + hasBeenDone + " alive: " + alive;
  }
}
