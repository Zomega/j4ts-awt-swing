...
/**
 * An event that characterizes a change in selection. The change is limited to a a single inclusive
 * interval. The selection of at least one index within the range will have changed. A decent {@code
 * ListSelectionModel} implementation will keep the range as small as possible. {@code
 * ListSelectionListeners} will generally query the source of the event for the new selected status
 * of each potentially changed row.
 *
