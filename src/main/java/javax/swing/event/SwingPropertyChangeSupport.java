...
/**
 * This subclass of {@code java.beans.PropertyChangeSupport} is almost identical in functionality.
 * The only difference is if constructed with {@code SwingPropertyChangeSupport(sourceBean, true)}
 * it ensures listeners are only ever notified on the <i>Event Dispatch Thread</i>.
 *
...
public final class SwingPropertyChangeSupport extends PropertyChangeSupport {
   ...
   * {@inheritDoc}
   *
   * <p>If {@link #isNotifyOnEDT} is {@code true} and called off the <i>Event Dispatch Thread</i>
   * this implementation uses {@code SwingUtilities.invokeLater} to send out the notification on the
