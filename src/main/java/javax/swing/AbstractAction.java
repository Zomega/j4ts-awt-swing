...
/**
 * This class provides default implementations for the JFC <code>Action</code> interface. Standard
 * behaviors like the get and set methods for <code>Action</code> object properties (icon, text, and
 * enabled) are defined here. The developer need only subclass this abstract class and define the
