...
/**
 * <code>JSeparator</code> provides a general purpose component for implementing divider lines -
 * most commonly used as a divider between menu items that breaks them up into logical groupings.
 * Instead of using <code>JSeparator</code> directly, you can use the <code>JMenu</code> or <code>
 * JPopupMenu</code> <code>addSeparator</code> method to create and add a separator. <code>
 * JSeparator</code>s may also be used elsewhere in a GUI wherever a visual divider is useful.
 *
...
public class JSeparator extends JComponent {
   ...
   *
   * @param orientation an integer specifying <code>SwingConstants.HORIZONTAL</code> or <code>
   ...
   *
   * @return The value of the orientation property, one of the following constants defined in <code>
   ...
   *
   * @param orientation either <code>SwingConstants.HORIZONTAL</code> or <code>
   *     SwingConstants.VERTICAL</code>
   * @exception IllegalArgumentException if <code>orientation</code> is neither <code>
   *     SwingConstants.HORIZONTAL</code> nor <code>SwingConstants.VERTICAL</code>
   * @see SwingConstants
  ...
  protected String paramString() {
    String orientationString =
        (orientation == SwingConstants.HORIZONTAL ? "HORIZONTAL" : "VERTICAL");
