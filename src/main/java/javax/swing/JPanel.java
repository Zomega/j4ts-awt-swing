...
public class JPanel extends JComponent {
  ...
  /**
   * Creates a new <code>JPanel</code> with <code>FlowLayout</code> and the specified buffering
   * strategy. If <code>isDoubleBuffered</code> is true, the <code>JPanel</code> will use a double
   * buffer.
   *
   * @param isDoubleBuffered a boolean, true for double-buffering, which uses additional memory
   *     space to achieve fast, flicker-free updates
