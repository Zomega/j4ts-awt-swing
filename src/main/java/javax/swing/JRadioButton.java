 ...
 * Used with a ButtonGroup object to create a group of buttons in
 * [cite_start]which only one button at a time can be selected. [cite: 563]
 *
 * This class assumes that JToggleButton is already implemented.
 *
...
public class JRadioButton extends JToggleButton {
    ...
    /**
     * [cite_start]Creates an initially unselected radio button with the specified image but no text. [cite: 632]
     * @param icon the image that the button should display
     */
    ...
    /**
     * [cite_start]Creates a radio button with the specified image and selection state, but no text. [cite: 633]
     * @param icon the image that the button should display
     * @param selected if true, the button is initially selected
     */
