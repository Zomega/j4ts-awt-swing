...
/**
 * A JSpinner class for JSweet, which simulates the functionality of the Java Swing JSpinner.
 * It's a compound component consisting of an editor and two buttons for stepping through a sequence.
 *
