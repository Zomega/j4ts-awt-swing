...
/**
 * An "IndexedPropertyChange" event gets delivered whenever a component that conforms to the
 * JavaBeans&trade; specification (a "bean") changes a bound indexed property. This class is an
 * extension of <code>PropertyChangeEvent</code> but contains the index of the property that has
 * changed.
 *
...
public class IndexedPropertyChangeEvent extends PropertyChangeEvent {
  ...
  public IndexedPropertyChangeEvent(
      Object source, String propertyName, Object oldValue, Object newValue, int index) {
