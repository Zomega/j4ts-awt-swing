 ...
 * ADJUSTMENT_LAST}.
 *
 * <p>The {@code type} of any {@code AdjustmentEvent} instance takes one of the following values:
 *
 * <ul>
...
public class AdjustmentEvent extends AWTEvent {
  ...
  /**
   * Constructs an <code>AdjustmentEvent</code> object with the specified <code>Adjustable</code>
