 ...
 *
 * <p>Normally the values of <code>width</code> and <code>height</code> are non-negative integers.
 * The constructors that allow you to create a dimension do not prevent you from setting a negative
...
public class Dimension extends Dimension2D implements java.io.Serializable {
  ...
  /**
   * Sets the size of this <code>Dimension</code> object to the specified width and height in double
   * precision. Note that if <code>width</code> or <code>height</code> are larger than <code>
   * Integer.MAX_VALUE</code>, they will be reset to <code>Integer.MAX_VALUE</code>.
   *
  ...
  /**
   * Sets the size of this <code>Dimension</code> object to the specified size. This method is
   * included for completeness, to parallel the <code>setSize</code> method defined by <code>
   * Component</code>.
   *
