...
public class GridBagConstraints {
  ...
  // TODO? transient Component.BaselineResizeBehavior baselineResizeBehavior;
  ...
  /**
   * Creates a <code>GridBagConstraint</code> object with all of its fields set to their default
   * value.
   */
