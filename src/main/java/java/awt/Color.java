...
public class Color implements Paint, java.io.Serializable {
  ...
  /**
   * Checks the color <code>float</code> components supplied for validity. Throws an <code>
   * IllegalArgumentException</code> if the value is out of range.
   *
   * @param r the Red component
   * @param g the Green component
   * @param b the Blue component
   ...
   * 1.0). Alpha is defaulted to 1.0. The actual color used in rendering depends on finding the best
   * match given the color space available for a particular output device.
   *
   * @throws IllegalArgumentException if <code>r</code>, <code>g</code> or <code>b</code> are
   ...
   *
   * @throws IllegalArgumentException if <code>r</code>, <code>g</code> <code>b</code> or <code>a
   *     </code> are outside of the range 0.0 to 1.0, inclusive
   * @param r the red component
   * @param g the green component
   * @param b the blue component
   * @param a the alpha component
   ...
   *
   * <p>The argument is treated as the name of a system property to be obtained. The string value of
   * this property is then interpreted as an integer which is then converted to a <code>Color</code>
   * object.
   *
   * <p>If the specified property is not found or could not be parsed as an integer then <code>null
   * </code> is returned.
   *
   ...
   * @return the <code>Color</code> converted from the system property, or the specified <code>Color
   *     </code>.
   * @see java.lang.System#getProperty(java.lang.String)
   * @see java.lang.Integer#getInteger(java.lang.String)
   * @see java.awt.Color#Color(int)
   ...
   * Color</code> object.
   *
   * <p>If the specified property is not found or could not be parsed as an integer then the integer
   ...
   * the {@link Paint#createContext specification} of the method in the {@link Paint} interface for
   * information on null parameter handling.
   *
   * @param cm the preferred ColorModel which represents the most convenient format for the caller
   *     to receive the pixel data, or {@code null} if there is no preference.
