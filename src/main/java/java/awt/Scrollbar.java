 ...
 *
 * This is a minimal stub implementation based on the Scrollbar API documentation.
 */
public class Scrollbar extends Component implements Adjustable {
    ...
    /**
     * Constructs a new vertical scroll bar. The default properties are:
     * orientation=VERTICAL, value=0, visibleAmount=10, minimum=0, maximum=100.
     */
    public Scrollbar() {
    ...
    /**
     * Constructs a new scroll bar with the specified orientation. The other
    ...
    public void createHTML() {
        ...
        inputElement.addEventListener("input", e -> {
            ...
            fireAdjustmentEvent(new AdjustmentEvent(this, AdjustmentEvent.ADJUSTMENT_VALUE_CHANGED, AdjustmentEvent.TRACK, this.value, false));
        });
    }
