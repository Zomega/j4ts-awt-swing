...
public abstract class Path2D implements Shape, Cloneable {
  ...
  public static class Float extends Path2D implements Serializable {
     ...
     * {@inheritDoc}
     *
     * <p>The iterator for this class is not multi-threaded safe, which means that the {@code
     * Path2D} class does not guarantee that modifications to the geometry of this {@code Path2D}
