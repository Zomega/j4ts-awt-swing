...
public abstract class RoundRectangle2D extends RectangularShape {
  ...
  /**
   * The <code>Float</code> class defines a rectangle with rounded corners all specified in <code>
   * float</code> coordinates.
   *
   * @since 1.2
   */
  public static class Float extends RoundRectangle2D implements Serializable {
    ...
    /**
     * Constructs a new <code>RoundRectangle2D</code>, initialized to location (0.0,&nbsp;0.0), size
  ...
  /**
   * The <code>Double</code> class defines a rectangle with rounded corners all specified in <code>
   ...
   * The iterator for this class is multi-threaded safe, which means that this <code>
   * RoundRectangle2D</code> class guarantees that modifications to the geometry of this <code>
   * RoundRectangle2D</code> object do not affect any iterations of that geometry that are already
   * in process.
   *
