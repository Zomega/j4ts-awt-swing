...
public abstract class QuadCurve2D implements Shape, Cloneable {
  ...
  public static class Float extends QuadCurve2D implements Serializable {
    ...
    /**
     * Constructs and initializes a <code>QuadCurve2D</code> with coordinates (0, 0, 0, 0, 0, 0).
     *
     * @since 1.2
     */
    public Float() {}
  ...
  /**
   * Sets the location of the end points and control points of this <code>QuadCurve2D</code> to the
   * <code>double</code> coordinates at the specified offset in the specified array.
   *
  ...
  /**
   * Sets the location of the end points and control point of this <code>QuadCurve2D</code> to the
  ...
  /**
   * Sets the location of the end points and control points of this <code>QuadCurve2D</code> to the
   * coordinates of the <code>Point2D</code> objects at the specified offset in the specified array.
   *
  ...
  /**
   * Sets the location of the end points and control point of this <code>QuadCurve2D</code> to the
   * same as those in the specified <code>QuadCurve2D</code>.
   *
  ...
  /**
   * Subdivides the quadratic curve specified by the <code>src</code> parameter and stores the
   * resulting two subdivided curves into the <code>left</code> and <code>right</code> curve
   * parameters. Either or both of the <code>left</code> and <code>right</code> objects can be the
   * same as the <code>src</code> object or <code>null</code>.
   *
   ...
   * non-complex roots back into the same array, returning the number of roots. The quadratic solved
   ...
   * </code>. The iterator for this class is not multi-threaded safe, which means that this <code>
   * QuadCurve2D</code> class does not guarantee that modifications to the geometry of this <code>
   * QuadCurve2D</code> object do not affect any iterations of that geometry that are already in
   * process.
   *
