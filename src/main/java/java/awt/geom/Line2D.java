...
public abstract class Line2D implements Shape, Cloneable {
  ...
  public static class Float extends Line2D implements Serializable {
    ...
    /**
     * Constructs and initializes a <code>Line2D</code> from the specified <code>Point2D</code>
     * objects.
     *
  ...
  /**
   * Sets the location of the end points of this <code>Line2D</code> to the specified <code>Point2D
   * </code> coordinates.
   *
  ...
  /**
   * Sets the location of the end points of this <code>Line2D</code> to the same as those end points
   * of the specified <code>Line2D</code>.
   *
  ...
  /**
   * Returns an indicator of where the specified <code>Point2D</code> lies with respect to this line
  ...
  /**
   * Returns the square of the distance from a <code>Point2D</code> to this line segment. The
   * distance measured is the distance between the specified point and the closest point between the
   * current line's end points. If the specified point intersects the line segment in between the
   * end points, this method returns 0.0.
   *
   * @param pt the specified <code>Point2D</code> being measured against this line segment.
   * @return a double value that is the square of the distance from the specified <code>Point2D
   *     </code> to the current line segment.
  ...
  /**
   * Returns the distance from a <code>Point2D</code> to this line segment. The distance measured is
   * the distance between the specified point and the closest point between the current line's end
   * points. If the specified point intersects the line segment in between the end points, this
   * method returns 0.0.
   *
  ...
  /**
   * Returns the square of the distance from a specified <code>Point2D</code> to this line. The
   * distance measured is the distance between the specified point and the closest point on the
   * infinitely-extended line defined by this <code>Line2D</code>. If the specified point intersects
  ...
  /**
   * Returns the distance from a <code>Point2D</code> to this line. The distance measured is the
   * distance between the specified point and the closest point on the infinitely-extended line
   * defined by this <code>Line2D</code>. If the specified point intersects the line, this method
   * returns 0.0.
   *
  ...
  /**
   * Tests if a specified coordinate is inside the boundary of this <code>Line2D</code>. This method
   * is required to implement the {@link Shape} interface, but in the case of <code>Line2D</code>
  ...
  /**
   * Tests if a given <code>Point2D</code> is inside the boundary of this <code>Line2D</code>. This
   * method is required to implement the {@link Shape} interface, but in the case of <code>Line2D
   * </code> objects it always returns <code>false</code> since a line contains no area.
   *
  ...
  /**
   * Tests if the interior of this <code>Line2D</code> entirely contains the specified <code>
   * Rectangle2D</code>. This method is required to implement the <code>Shape</code> interface, but
   * in the case of <code>Line2D</code> objects it always returns <code>false</code> since a line
   * contains no area.
   *
  ...
  /**
   * Returns an iteration object that defines the boundary of this <code>Line2D</code>. The iterator
   * for this class is not multi-threaded safe, which means that this <code>Line2D</code> class does
   * not guarantee that modifications to the geometry of this <code>Line2D</code> object do not
