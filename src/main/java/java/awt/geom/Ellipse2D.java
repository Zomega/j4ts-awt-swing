...
public abstract class Ellipse2D extends RectangularShape {
  ...
  /**
   * The <code>Float</code> class defines an ellipse specified in <code>float</code> precision.
   *
   * @since 1.2
   */
  public static class Float extends Ellipse2D implements Serializable {
    ...
    /**
     * Constructs a new <code>Ellipse2D</code>, initialized to location (0,&nbsp;0) and size
     * (0,&nbsp;0).
     *
     * @since 1.2
     */
  ...
  /**
   * The <code>Double</code> class defines an ellipse specified in <code>double</code> precision.
   *
   * @since 1.2
   */
  ...
  /**
   * Returns an iteration object that defines the boundary of this <code>Ellipse2D</code>. The
   * iterator for this class is multi-threaded safe, which means that this <code>Ellipse2D</code>
   * class guarantees that modifications to the geometry of this <code>Ellipse2D</code> object do
