...
public abstract class RectangularShape implements Shape, Cloneable {
  ...
  /**
   * Sets the framing rectangle of this <code>Shape</code> to be the specified <code>Rectangle2D
   * </code>. The framing rectangle is used by the subclasses of <code>RectangularShape</code> to
   ...
   * <code>Point2D</code> objects. The framing rectangle is used by the subclasses of <code>
   * RectangularShape</code> to define their geometry.
   *
  ...
  /**
   * Sets the framing rectangle of this <code>Shape</code> based on a specified center <code>Point2D
   * </code> and corner <code>Point2D</code>. The framing rectangle is used by the subclasses of
   * <code>RectangularShape</code> to define their geometry.
   *
