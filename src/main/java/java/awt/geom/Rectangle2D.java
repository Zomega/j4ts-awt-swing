...
public abstract class Rectangle2D extends RectangularShape {
  ...
  public static class Float extends Rectangle2D implements Serializable {
     ...
     * coordinates.
     *
     * @param x the X coordinate of the upper-left corner of the newly constructed <code>Rectangle2D
     *     </code>
     * @param y the Y coordinate of the upper-left corner of the newly constructed <code>Rectangle2D
     *     </code>
   ...
   * @return <code>true</code> if the specified line segment intersects the interior of this <code>
   ...
   * </code>. This method computes a binary OR of the appropriate mask values indicating, for each
   * side of this <code>Rectangle2D</code>, whether or not the specified <code>Point2D</code> is on
   ...
   *     each other
   * @param dest the <code>Rectangle2D</code> that holds the results of the intersection of <code>
   ...
   * @return the smallest <code>Rectangle2D</code> containing both the specified <code>Rectangle2D
   ...
   *     other
   * @param dest the <code>Rectangle2D</code> that holds the results of the union of <code>src1
