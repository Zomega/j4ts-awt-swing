...
/**
 * The <code>FlatteningPathIterator</code> class returns a flattened view of another {@link
 * PathIterator} object. Other {@link java.awt.Shape Shape} classes can use this class to provide
 * flattening behavior for their paths without having to perform the interpolation calculations
 * themselves.
 *
 * @author Jim Graham
 */
public class FlatteningPathIterator implements PathIterator {
   ...
   * over it. The iterator does not subdivide any curve read from the source iterator to more than
   * 10 levels of subdivision which yields a maximum of 1024 line segments per curve.
   *
