...
public abstract class Point2D implements Cloneable {
  ...
  /**
   * Sets the location of this <code>Point2D</code> to the same coordinates as the specified <code>
   * Point2D</code> object.
   *
  ...
  /**
   * Returns the square of the distance from this <code>Point2D</code> to a specified <code>Point2D
   * </code>.
   *
   * @param pt the specified point to be measured against this <code>Point2D</code>
   * @return the square of the distance between this <code>Point2D</code> to a specified <code>
   *     Point2D</code>.
   * @since 1.2
   */
