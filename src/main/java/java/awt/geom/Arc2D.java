...
public abstract class Arc2D extends RectangularShape {
   ...
   *
   * <p>This constructor creates an object with a default closure type of {@link #OPEN}. It is
  ...
  public boolean contains(double x, double y) {
    ...
    boolean inside =
        (Line2D.relativeCCW(x1, y1, x2, y2, 2 * normx, 2 * normy)
   ...
   * safe. <code>Arc2D</code> guarantees that modifications to the geometry of the arc do not affect
