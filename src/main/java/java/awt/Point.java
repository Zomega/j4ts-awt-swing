...
public class Point extends Point2D implements java.io.Serializable {
   ...
   * completeness, to parallel the <code>setLocation</code> method of <code>Component</code>.
   *
   ...
   * rounded to integer values. Any number smaller than <code>Integer.MIN_VALUE</code> will be reset
   * to <code>MIN_VALUE</code>, and any number larger than <code>Integer.MAX_VALUE</code> will be
