...
public class Cursor implements java.io.Serializable {
   ...
   *
   * <p>Note: this constructor should only be used by AWT implementations as part of their support
   * for custom cursors. Applications should use Toolkit.createCustomCursor().
   *
